...
function EditEmployee() {
    ...
    useEffect(() => {
        Axios.get("https://backend-cdu3.onrender.com/employeeRoute/update-employee/" + id)
            .then((res) => {
                if (res.status === 200) {
    ...
    const handleSubmit = () => {
        ...
        Axios.put("https://backend-cdu3.onrender.com/employeeRoute/update-employee/" + id, newObj)
            .then((res) => {
                if (res.status === 200) {
